...
Given 'n' points, implement Graham Scan algorithm to find perimeter of the convex hull formed.
You are given a code to find the convex hull. Add code to find the perimeter of the polygon
formed by Graham Scan

Input Format
First line contains the number of points, n
Next 'n' lines contain the points in the input

Output Format
Print only two decimal places of the perimeter of the polygon formed
*/
