...
{
    // store the sum of 'i' elements as key and value of 'i' as value in a map
    ...
    d.low = -1;
    d.high = -1;
    // store sum as 0 elements to handle case when entire array sums to 0
    sum_index[0] = 0;
...
int main()
{
    ...
    if(d.low == -1)
        ...
        cout << "0-based indexing => Start: " << d.low << " End: " << d.high << endl;
}