...
Given a set 'S' of 'n' activities, implement the recursive greedy algorithm to 
select a subset of activities from S by selecting the task that starts last. 
Build a priority queue (max heap) based on start time and then select the activities
