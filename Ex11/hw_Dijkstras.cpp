// Incomplete, seeing maam's github
/*
Print Path Djikstra Algorithm
Given the code to consrtuct table by Djikstra's algorithm, write a 
function to interpret the table and print the path from source vertex 
to the destination vertex

 
Input Format
First line contains the number of vertices in the graph, n
Next few lines contain 
Name of each vertex and number of adjacent vertices, m
next 'm' lines contain the name of adjacent vertices and the distance
Name of the source vertex, S
Name of the destination vertex, d

Output Format
Print the path from source to destination vertex
For the above graph, if v1 is the source vertex and  destination is v7 then the code should print
...
void path_printer(map<string,table_details> dij_table, string source, string destination)
{
